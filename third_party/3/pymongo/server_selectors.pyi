...
class Selection(object):
    ...
    def from_topology_description(
        cls: type,
        topology_description: TopologyDescription) -> 'Selection': ...
    def __init__(self,
    ...
    def with_server_descriptions(
        self,
        server_descriptions: Sequence[ServerDescription]) -> 'Selection': ...
...
def apply_single_tag_set(tag_set: Mapping[str, Any], selection: Selection)\
    -> Selection: ...
def apply_tag_sets(tag_sets: Sequence[Mapping[str, Any]],
                   selection: Selection) -> Selection: ...
def secondary_with_tags_server_selector(
    tag_sets: Sequence[Mapping[str, Any]],
    selection: Selection) -> Selection: ...
