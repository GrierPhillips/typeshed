...
class Server(object):
    def __init__(self, server_description: ServerDescription, pool: Pool,
                 monitor: Monitor, topology_id: Optional[ObjectId] = None,
                 listeners: Optional[_EventListeners] = None,
                 events: Optional[Queue] = None) -> None: ...
    def open(self) -> None: ...
    def reset(self) -> None: ...
    def close(self) -> None: ...
    def request_check(self) -> None: ...
    def send_message(self, message: Tuple[int, bytes],
    ...
    def send_message_with_response(
        ...
        exhaust: bool = False) -> Response: ...
    @contextlib.contextmanager
    def get_socket(self, all_credentials: Mapping[str, MongoCredential],
                   checkout: bool = False) -> Iterator[SocketInfo]: ...
    @property
    ...
    def _split_message(
        self,
        message: Union[Tuple[int, bytes, int], Tuple[int, bytes]])\
        -> Tuple[int, bytes, int]: ...
