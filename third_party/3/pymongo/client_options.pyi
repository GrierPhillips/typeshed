...
def _parse_credentials(username: str, password: str, database: str,
                       options: Dict[str, Any])\
    -> Union[MongoCredential, None]: ...
...
def _parse_ssl_options(options: Dict[str, Any])\
    -> Tuple[Union[SSLContext, None], bool]: ...
