...
class _EventListeners(object):
    ...
    def publish_command_start(self, command: Mapping[str, Any], database_name: str, request_id: int, connection_id: Tuple[str, int], op_id: Optional[int] = None) -> None: ...
    def publish_command_success(self, duration: datetime.timedelta, reply: Mapping[str, Any], command_name: str, request_id: int, connection_id: Tuple[str, int], op_id: Optional[int] = None) -> None: ...
    def publish_command_failure(self, duration: datetime.timedelta, failure: Mapping[str, Any], command_name: str, request_id: int, connection_id: Tuple[str, int], op_id: Optional[int] = None) -> None: ...
