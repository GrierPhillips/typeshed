from typing import (Any, List, Mapping, NamedTuple, Optional, Set, Sequence,
                    Tuple, Union)
import datetime
...
class _Listeners(NamedTuple):
    command_listeners: List[CommandListener]
    server_listeners: List[ServerListener]
    server_heartbeat_listeners: List[ServerHeartbeatListener]
    topology_listeners: List[TopologyListener]
_LISTENERS: _Listeners = _Listeners([], [], [], [])
...
def _validate_event_listeners(option: str,
                              listeners: Sequence[_EventListener])\
    -> Sequence[_EventListener]: ...
def register(listener: _EventListener) -> None: ...
_SENSITIVE_COMMANDS: Set[str] = set(
...
class _CommandEvent(object):
    def __init__(self, command_name: str, request_id: int,
                 connection_id: Tuple[str, int], operation_id: int)\
        -> None: ...
    @property
...
class CommandStartedEvent(_CommandEvent):
    def __init__(self, command: Mapping[str, Any], database_name: str,
                 *args: Any) -> None: ...
    @property
...
class CommandSucceededEvent(_CommandEvent):
    def __init__(self, duration: datetime.timedelta, reply: Mapping[str, Any],
                 command_name: str, request_id: int,
                 connection_id: Tuple[str, int], operation_id: Any)\
        -> None: ...
    @property
...
class CommandFailedEvent(_CommandEvent):
    def __init__(self, duration: datetime.timedelta,
                 failure: Mapping[str, Any], *args: Any) -> None: ...
    @property
    def duration_micros(self) -> int: ...
    @property
...
class ServerHeartbeatSucceededEvent(_ServerHeartbeatEvent):
    def __init__(self, duration: int, reply: IsMaster,
                 *args: Any) -> None: ...
    @property
...
class _EventListeners(object):
    ...
    def publish_command_start(self, command: Mapping[str, Any],
                              database_name: str, request_id: int,
                              connection_id: Tuple[str, int],
                              op_id: Optional[int] = None) -> None: ...
    def publish_command_success(self, duration: datetime.timedelta,
                                reply: Mapping[str, Any], command_name: str,
                                request_id: int,
                                connection_id: Tuple[str, int],
                                op_id: Optional[int] = None) -> None: ...
    def publish_command_failure(self, duration: datetime.timedelta,
                                failure: Mapping[str, Any], command_name: str,
                                request_id: int,
                                connection_id: Tuple[str, int],
                                op_id: Optional[int] = None) -> None: ...
    def publish_server_heartbeat_started(
        self,
        connection_id: Tuple[str, int]) -> None: ...
