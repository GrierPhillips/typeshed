...
class InsertOneResult(_WriteResult):
    def __init__(self, inserted_id: List[Any], acknowledged: bool) -> None: ...
    @property
...
class DeleteResult(_WriteResult):
    def __init__(self, raw_result: Mapping[str, Any], acknowledged: bool)\
        -> None: ...
    @property
    def raw_result(self) -> Mapping[str, Any]: ...
    @property
...
class BulkWriteResult(_WriteResult):
    ...
    @property
    def upserted_ids(self) -> Mapping[Any, Any]: ...
